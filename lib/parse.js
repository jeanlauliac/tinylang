...
function parseIfSt(state) {
  ...
  // FIXME: the concept of block should be inside `parseFunSt()`, we don't care about
  // it here, remove "sts" and have a single statement instead.
...
const KEYWORDS = new Set(['export', 'if', 'return', 'true', 'false']);
